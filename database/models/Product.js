...
module.exports = (sequelize, dataTypes) => {
    ...
    let alias= "Products"; //Normally, the name of the model/tables in SQL goes in plural. The name of the alias, is gonna be the first atribute in the definition of model (at the end), and in convention, goes in PLURAL.
